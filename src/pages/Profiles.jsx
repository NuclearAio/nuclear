    ...
    <div className="">
      ...
      <aside>
        <div className="flex  justify-end mr-9 gap-3 ">
          <button type="button" className="px-3 py-1 hover rounded-md tracking-tighter bg-secondary-100 transition delay-100 ease-in">
            <spam className="p-2.5 text-center font-semibold">
              Add
            </spam>
          </button>
          <button type="button" className="px-3 py-1 rounded-md tracking-tighter bg-red-600  transition delay-100 ease-in hover:bg-red-700">
            <spam className="text-white text-center font-semibold">
              Delete all
            </spam>
          </button>
      ...
      <div className="container p-2 mx-auto sm:p-4 -ml-4">
        <div className="overflow-x-auto h-96 f">
