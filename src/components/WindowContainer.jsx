    ...
    <>
      <div className="bg-base h-screen relative">
        <section className="h-screen  ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between  bg-primary transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
          <div>
            <div className="-mx-7 px-6 py-4 flex">
              <a href="#" title="home">
                <img src={Logo} className="w-24" alt="tailus logo" />
              </a>
              <h1 className="justify-end mt-2.5  -ml-3 font-light text-3xl">nuclear</h1>
            </div>
          ...
          <div className="px-6 -mx-6 pt-0.5 flex justify-between items-center border-t border-gray-700">
            <button className="px-4 py-3 flex items-center space-x-4  group hover transition delay-100 ease-in w-full mt-2 rounded-md">
              <svg
        ...
        <div className=" ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
          <div className="sticky z-50 top-0 h-16 bg-base lg:py-2.5">
            <div className="px-6 flex items-center justify-between space-x-4 2xl:container">
              <h5 hidden className="text-5xl font-semibold  lg:block tracking-tighter">
                Anylitics
              </h5>
